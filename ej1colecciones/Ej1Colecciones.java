...
la lista ordenada.*/
    public void eliminarPerro() {
        ...
        while (it.hasNext()) { // boleano que devuelve si hay o no para iterar y se va a la lista si hay datos (true). siempre con while
            String aux1 = it.next(); // next primer elemento donde va a empezar a buscar
            if (aux1.equalsIgnoreCase(raza)) {
                it.remove();
                encontrado = true;
            }
        }
